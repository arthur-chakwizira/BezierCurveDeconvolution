function percent = my_parfor_progress(handles, caller, N)
...
if N > 0
    ...
    if nargout == 0
%          disp(['  0%[>', repmat(' ', 1, w), ']']);
        set(handles.edit7, 'String', '', 'ForegroundColor', 'b')
        wrap_text = (['  0%[>', repmat(' ', 1, w), ']']);
...
set(handles.edit7, 'String', '', 'ForegroundColor', 'b')
wrap_text = ([repmat(char(8), 1, (w+9)), '100%[', repmat('=', 1, w+1), ']']);
        set(handles.edit7, 'String', wrap_text, 'ForegroundColor', 'b')
        drawnow
    end
else
...
%         disp([repmat(char(8), 1, (w+9)), char(10), perc, '[', repmat('=', 1, round(percent*w/100)), '>', repmat(' ', 1, w - round(percent*w/100)), ']']);
        set(handles.edit7, 'String', '', 'ForegroundColor', 'b')
wrap_text = ([repmat(char(8), 1, (w+9)), perc, '[', repmat('=', 1, round(percent*w/100)), '>', repmat(' ', 1, w - round(percent*w/100)), ']']);
        set(handles.edit7, 'String', wrap_text, 'ForegroundColor', 'b')
        drawnow
    end
end