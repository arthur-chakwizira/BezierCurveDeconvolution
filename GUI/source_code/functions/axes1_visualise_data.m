function axes1_visualise_data(handles)
%This function is called when user pushes the "Visualise" button on axes1
%        Author:
%              Arthur Chakwizira
...
if isfield(handles, 'axes1_folder')
    file_folder = handles.axes1_folder;
...
%     set(handles.axes2, 'box', 'on')
    ...
    [base_folder, file_name, file_ext] = fileparts(path_to_axes1_data);
    ...
    if isstruct(axes1_pre_data)
        axes1_data = squeeze(axes1_pre_data.the_data); %remove singular dimensions as they will confuse sliders
    ...
    handles.axes1_folder = base_folder;
...
handles = guidata(hObject);
handles.axes1_data = double(handles.axes1_data);
set(handles.slider1, 'Visible', 'off') %slice
set(handles.slider6, 'Visible', 'off') %color
set(handles.slider10, 'Visible', 'off') %color
set(handles.slider8, 'Visible', 'off') %time
set(handles.pushbutton15, 'Visible', 'off') %cmap
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes1
set(handles.togglebutton2, 'Visible', 'off') %cbar
d_x = 1;
x = 0:d_x:d_x*(max(handles.size_axes1_data)-1);
plot(x, handles.axes1_data, 'k-','LineWidth',2, 'Parent', handles.axes1)
title(handles.axes1, handles.axes1_filename, 'Interpreter', 'none')
...
handles = guidata(hObject);
handles.axes1_data = double(handles.axes1_data);
set(handles.pushbutton30, 'String', 'Show data in ROI(s)');
set(handles.pushbutton30, 'Visible', 'on');
set(handles.pushbutton30, 'Callback', {@Show2D})
set(handles.pushbutton26, 'Visible', 'on');
set(handles.pushbutton24, 'Visible', 'on');
set(handles.pushbutton26, 'Callback', {@addROI});
set(handles.pushbutton24, 'Callback', {@clearROIs_2D});
set(handles.slider1, 'Visible', 'off');%slices
set(handles.slider8, 'Visible', 'off'); %time point
set(handles.slider6, 'Visible', 'on') %color
set(handles.slider10, 'Visible', 'on') %color
set(handles.pushbutton15, 'Visible', 'on') %colormap, ok
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes2; not allowing this anymore due to ROI placement functionality
set(handles.togglebutton2, 'Visible', 'on') %colorbar, ok
guidata(hObject, handles)
...
set(handles.pushbutton30, 'String', 'Show data in ROI(s)');
set(handles.pushbutton30, 'Visible', 'on');
set(handles.pushbutton30, 'Callback', {@Show3D})
set(handles.pushbutton26, 'Visible', 'on');
set(handles.pushbutton24, 'Visible', 'on');
set(handles.pushbutton26, 'Callback', {@addROI});
set(handles.pushbutton24, 'Callback', {@clearROIs_3D});
set(handles.pushbutton15, 'Visible', 'on') %colormap, ok
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes1; not allowing this anymore due to ROI placement functionality
set(handles.togglebutton2, 'Visible', 'on') %colorbar, ok
set(handles.slider1, 'Callback', {@change_slice_3D});
guidata(hObject, handles)
initialise_roi_placement(hObject);
...
set(handles.pushbutton30, 'String', 'Show data in ROI(s)');
set(handles.pushbutton30, 'Visible', 'on');
set(handles.pushbutton30, 'Callback', {@Show4D})
set(handles.pushbutton26, 'Visible', 'on');
set(handles.pushbutton24, 'Visible', 'on');
set(handles.pushbutton26, 'Callback', {@addROI});
set(handles.pushbutton24, 'Callback', {@clearROIs_4D});
set(handles.pushbutton15, 'Visible', 'on') %colormap, ok
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes1; not allowing this anymore due to ROI placement functionality
set(handles.togglebutton2, 'Visible', 'on') %colorbar, ok
set(handles.slider1, 'Callback', {@change_slice_4D});
...
handles = guidata(hObject);
dummy_data = handles.axes1_data(:); dummy_data(~isfinite(dummy_data)) = []; dummy_data(isnan(dummy_data)) = [];
...
handles.axes1_image = imshow(handles.axes1_data, 'colormap', gray, 'Parent', handles.axes1);
handles.axes1.CLim = [clim_min clim_max];
title(handles.axes1, handles.axes1_filename, 'Interpreter', 'none')
set(handles.slider6, 'Min', clim_min, 'Max', clim_max, ...
    'SliderStep', [step_small, step_big], 'Value', clim_max)
set(handles.slider10, 'Visible', 'on') %color setting
set(handles.slider10, 'Min', clim_min, 'Max', clim_max-1E-10, ...
...
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes1, not allowed anymore due to ROI placement
set(handles.togglebutton2, 'Visible', 'on')
current_slice = round(handles.size_axes1_data(3)/2) ;
handles.axes1_image = imshow(squeeze(handles.axes1_data(:,:,current_slice)), 'colormap', gray, 'Parent', handles.axes1);
dummy_data = handles.axes1_data(:); dummy_data(~isfinite(dummy_data)) = []; dummy_data(isnan(dummy_data)) = [];
% dummy_mean = mean(dummy_data);
% dummy_std = std(dummy_data);
% dummy_data(dummy_data > (dummy_mean + 5*dummy_std)) = [];
...
if clim_max > 99; step_small = 1/clim_max; step_big = step_small; end
handles.axes1.CLim = [clim_min clim_max];
set(handles.slider1, 'Min', 1, 'Max', handles.size_axes1_data(3), ... %slices
    'SliderStep', [1, 1]/(handles.size_axes1_data(3) - 1), 'Value', current_slice)
...
set(handles.slider6, 'Visible', 'on')
set(handles.pushbutton15, 'Visible', 'on')
set(handles.pushbutton17, 'Visible', 'off')%rotate image on axes2
set(handles.togglebutton2, 'Visible', 'on')
current_slice = round(handles.size_axes1_data(3)/2);
current_timepoint = 1;
handles.axes1_image = imshow(squeeze(handles.axes1_data(:,:,current_slice,current_timepoint)), 'colormap', gray, 'Parent', handles.axes1);
dummy_data = handles.axes1_data(:); dummy_data(~isfinite(dummy_data)) = []; dummy_data(isnan(dummy_data)) = [];
% dummy_mean = mean(dummy_data);
% dummy_std = std(dummy_data);
% dummy_data(dummy_data > (dummy_mean + 5*dummy_std)) = [];
...
if clim_max > 99; step_small = 1/clim_max; step_big = step_small; end
handles.axes1.CLim = [clim_min clim_max];
set(handles.slider1, 'Min', 1, 'Max', handles.size_axes1_data(3), ... %1st and 2nd dimensions
    'SliderStep', [1, 1]/(handles.size_axes1_data(3) - 1), 'Value', current_slice)
set(handles.slider6, 'Visible', 'on') %color setting
set(handles.slider6, 'Min', clim_min, 'Max', clim_max, ...
    'SliderStep', [step_small, step_big], 'Value', clim_max)
...
set(handles.slider10, 'Min', clim_min, 'Max', clim_max-1E-10, ...
    'SliderStep', [step_small, step_big], 'Value', clim_min)
set(handles.slider8, 'Min', 1, 'Max', handles.size_axes1_data(4), ... %4th dimension
    'SliderStep', [1, 1]/(handles.size_axes1_data(4) - 1), 'Value', 1)
title(handles.axes1, handles.axes1_filename, 'Interpreter', 'none')
guidata(hObject, handles)
end
...
if numel(handles.size_axes1_data) > 2
    handles.roi_mask = false(handles.size_axes1_data(1:3));
else
    handles.roi_mask = false(handles.size_axes1_data);
end
guidata(hObject, handles)
end
...
initialise_roi_placement(hObject)
prepare_sliders_2D(hObject)
set(handles.axes1, 'Colormap', cmap)
end
...
cmap = handles.axes1.Colormap;
cla(handles.axes1, 'reset')
handles.axes1_image = imshow(zeros(handles.size_axes1_data(1:2)), clim_im, 'colormap', cmap, 'Parent', handles.axes1);
set(handles.axes1_image, 'CData', (squeeze(handles.axes1_data(:,:,current_slice))) )
guidata(hObject, handles)
initialise_roi_placement(hObject)
end
...
ch = get(handles.axes2, 'Children');
for cc = 1:numel(ch)
    if ~strcmp(ch(cc).DisplayName, 'Mouse tracking'); delete(ch(cc)); end
end
current_slice = round(get(handles.slider1, 'Value'));
current_timepoint = round(get(handles.slider8, 'Value'));
current_cmap = handles.axes1.Colormap;
cla(handles.axes1, 'reset')
handles.axes1_image = imshow(zeros(handles.size_axes1_data(1:2)), clim_im, 'colormap', current_cmap, 'Parent', handles.axes1);
set(handles.axes1_image, 'CData', (squeeze(handles.axes1_data(:,:,current_slice, current_timepoint))) )
guidata(hObject, handles)
initialise_roi_placement(hObject)
initialise_dynamic_plot(hObject)
end
...
reset_axes2(hObject)
active_rois = handles.rois(ishandle(handles.rois));
roi_mask = false(handles.size_axes1_data); %total mask
img_size = handles.size_axes1_data;
axes1_data = handles.axes1_data;
for c_roi = 1:numel(active_rois) %use meshgrid if this is slow
    h_roi = active_rois(c_roi);
    tmp_mask = false(handles.size_axes1_data); %individual mask
    for x = 1:img_size(1)
        for y = 1:img_size(2)
            if inROI(h_roi, x,y)
                tmp_mask(y,x) = true;
...
ydata = axes1_data(roi_mask);
histogram(handles.axes2, ydata, 'FaceColor', 'k');
ymean = mean(ydata);
ystd = std(ydata);
legend(handles.axes2, "Mean = "+ num2str(round(ymean,2)) + ";  Std = " + num2str(round(ystd, 2)))
set(handles.axes2, 'fontsize', 11)
ylabel(handles.axes2, 'Count')
xlabel(handles.axes2, 'Value')
guidata(hObject, handles)
end
...
handles = guidata(hObject);
handles.axes1_image = imshow(handles.axes1_data, 'Parent', handles.axes1); %ensure correct visualisation of rgb photos
set(handles.slider1, 'Visible', 'off') %slice
set(handles.slider8, 'Visible', 'off')%time point
set(handles.slider10, 'Visible', 'on')
set(handles.slider6, 'Visible', 'on') 
set(handles.pushbutton15, 'Visible', 'on')
set(handles.pushbutton17, 'Visible', 'on')%rotate image on axes2
set(handles.togglebutton2, 'Visible', 'on')
title(handles.axes1, handles.axes1_filename, 'Interpreter', 'none')
guidata(hObject, handles)
end
...
for c_roi = 1:numel(active_rois) %use meshgrid if this is slow
    ...
    tmp_mask = false(handles.size_axes1_data(1:2)); %individual mask
    for x = 1:img_size(1)
        for y = 1:img_size(2)
            if inROI(h_roi, x,y)
                tmp_mask(y,x) = true;
...
roi_mask = false(handles.size_axes1_data(1:3)); %total mask
img_size = handles.size_axes1_data;
...
for x = 1:img_size(1)
    for y = 1:img_size(2)
        for z = 1:img_size(3)
            if roi_mask(x,y,z)
                c_ydata = c_ydata+1;
                ydata(c_ydata, :) = squeeze(axes1_data(x,y,z,:));
            end
        end
    end
end
...
for c = 1:c_ydata
    plot(handles.axes2, x, ydata(c, :), '-', 'LineWidth', 0.2, 'Color', [0.7 0.7 0.7], 'HandleVisibility', 'off')
end
ystd = std(ydata, 0, 1);
ymean = mean(ydata, 1);

if numel(ymean) <= 5; stil = 'o-'; else; stil = '-'; end
plot(handles.axes2, x, ymean, stil, 'Color', 'k', 'Linewidth', 3)
plot(handles.axes2, x, ymean+ystd, 'k--', 'Linewidth', 2)
plot(handles.axes2, x, ymean-ystd, 'k--', 'Linewidth', 2, 'HandleVisibility', 'off')
% ylim(handles.axes1, [0.5*min(ydata(:)), 2*max(ydata(:))])
% legstr = handles.axes1.Legend.String;
legend(handles.axes2, ["Mouse tracking", "Mean", "\pm 1 std"])
guidata(hObject, handles)
end
...
set(handles.axes1_image, 'CData', squeeze(handles.axes1_data(:,:,current_slice,current_time_point)))
active_rois = handles.rois(ishandle(handles.rois));
active_roi_slices = handles.roi_slices(ishandle(handles.rois));
set(active_rois, 'Parent', []);
set(active_rois(active_roi_slices == current_slice), 'Parent', handles.axes1);
...
ymin = min(dummy_data);
ymax = max(dummy_data);
handles.dynamic_plot = plot(handles.axes2,1:size_axes1_data(4), NaN(1,size_axes1_data(4)), 'r:', 'LineWidth', 2);
if handles.use_dsc_data_for_roi
    set(handles.axes2,'XLim', [floor(min(handles.t)) ceil(max(handles.t))])
else
    set(handles.axes2, 'XLim', [1 handles.size_axes1_data(4)])
end
set(handles.axes2, 'YLim', [ymin ymax])
set(handles.axes2, 'Linewidth', 1.2, 'fontsize', 11)
xlabel(handles.axes2, 'Index')
ylabel(handles.axes2, '4th dimension')
...
handles = guidata(hObject);
if ~isfield(handles, 'axes1_image'); return; end
if ~ishandle(handles.axes1_image); return; end
...
try
    if handles.use_dsc_data_for_roi
        ydata = squeeze(handles.axes1_data_2(y,x,sl,:));
    else
        ydata = squeeze(handles.axes1_data(y,x,sl,:));
    end
...
function reset_axes2(hObject)
handles = guidata(hObject);
cla(handles.axes2, 'reset')
 set([handles.pushbutton31, handles.pushbutton32,handles.pushbutton33, handles.pushbutton34, handles.pushbutton35], 'Visible', 'off') %initially turn off all these buttons
 set([handles.slider2, handles.slider9, handles.slider7, handles.slider11,  handles.pushbutton16,  handles.pushbutton18, handles.togglebutton3], 'Visible', 'off')
 % set(handles.axes2,'XTick', [], 'YTick', [], 'box', 'on') %set default appearance for axes
set(handles.axes2,'box', 'on')
guidata(hObject, handles)
end
...
handles = guidata(hObject);
if strcmp(handles.axes1_filename, 'residue_functions_BzD') || strcmp(handles.axes1_filename,'residue_functions_SVD')
...
%         end
        ...
        handles.axes1_data_2 = handles.axes1_data;
        handles.axes1_data = handles.dsc_data_filtered;
        size_axes1_data = size(handles.axes1_data_2);
        handles.size_axes1_data = size_axes1_data;
        handles.path_to_axes1_data = handles.path_to_data;
        handles.axes1_filename = handles.file_name;
        guidata(hObject, handles)
        prepare_sliders_4D(hObject)
    end
else
...
handles.dsc_data = double(dsc_data);
handles.mask = mask;
