function [r_svd, cbf_svd, delay_svd] = oSVD_deconvolution_gui(handles)
%        This function handles oSVD deconvolution. It does not display
...
ppm = ParforProgressbar(numIterations,'showWorkerProgress',false,'progressBarUpdatePeriod',3,'title','oSVD deconvolution');
% tic
%__________________________________________________________________________
parfor x = xrange
...
%report completion
wrap_text = 'oSVD deconvolution complete';
